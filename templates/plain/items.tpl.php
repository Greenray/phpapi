...
[if=exception]
    ...
    <ul>
    [each=exception]
        <li><a href="{exception[path]}" title="{exception[name]}" target="_self">{exception[name]}</a></li>
    [/each.exception]
    </ul>
[/if.exception]
[if=function]
    ...
    <ul>
    [each=function]
        <li><a href="{function[path]}" title="{function[name]}" target="_self">{function[name]}</a></li>
    [/each.function]
    </ul>
[/if.function]
[if=global]
