 ...
 * Creative Commons Attribution-NonCommercial-Share Alike 4.1 Unported License as published by
...
#
} elseif (!extension_loaded('tokenizer') || version_compare(phpversion(), '5.4.1', '<')) {
