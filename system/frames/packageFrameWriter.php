        ...
        foreach ($packages as $name => $package) {
            ...
            if ($classes) {
                ...
                foreach ($classes as $i => $class) {
                    ...
                    $output['classes'][$i]['path']     = $class->path();
            ...
            if ($interfaces) {
                ...
                foreach ($interfaces as $i => $interface) {
                    ...
                    $output['interfaces'][$i]['path']     = $interface->path();
            ...
            if ($traits) {
                ...
                foreach ($traits as $i => $trait) {
                    ...
                    $output['traits'][$i]['path']     = $trait->path();
            ...
            if ($exceptions) {
                ...
                foreach ($exceptions as $i => $exception) {
                    ...
                    $output['exceptions'][$i]['path']     = $exception->path();
            ...
            if ($functions) {
                ...
                foreach ($functions as $i => $function) {
                    ...
                    $output['functions'][$i]['path']     = $function->path();
            ...
            if ($globals) {
                ...
                foreach ($globals as $i => $global) {
                    ...
                    $output['globals'][$i]['path'] = $global->path();
            ...
            $this->write($package->path().DS.'package-frame.html', $package->name, FALSE);
        }
